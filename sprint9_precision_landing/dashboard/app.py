...
with tabs[0]:
    ...
    fig_le, ax_le = plt.subplots(figsize=(10, 3))
    ax_le.plot(log.t, log.lateral_true, lw=1.4)
    ax_le.set_xlabel("t [s]"); ax_le.set_ylabel("lateral error [m]")
    ax_le.set_ylim(bottom=0)
    st.pyplot(fig_le)
